...
DRIVER_VERSION = "Quansheng UV-K5/K6/5R driver ver: 2024/10/23 (c) EGZUMER + F4HWN v3.6.0 FR"
...
PDF_FILE_ALAIN_UPDATE = "https://www.dropbox.com/scl/fi/2sqfolv3vtbhq69h037i3/MENU-FIRMWARE-F4HWN-v3.5.pdf?rlkey=q5a74wi88q3a02lnla6xtl75u&e=1&dl=0"
...
# end add menu firmware with version and option display
        ...
        SetOffSetting = RadioSetting("set_nfm", "Set NFM (SetNFM)", val)
        SetOffSetting.set_doc('SetNFM: Reglage de la largeur de bande Narrow FM \n' + \
                              '* 12.5 kHz \n' + \
                              '* 6.25 kHz')
