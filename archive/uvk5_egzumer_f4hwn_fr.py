...
DRIVER_VERSION = "Quansheng UV-K5/K6/5R driver ver: 2024/03/22 (c) EGZUMER + F4HWN v2.3.0 FR"
...
#
        ...
        append_label(help_group,"(T) = Transmission" , "Ligne Status " )
        append_label(help_group,"(PS) = Economie d'energie" , "Ligne Status " )
        append_label(help_group,"(S) = Le mode SCAN est active" , "Ligne Status" )
        append_label(help_group,"(><) = " , "Ligne Status " )
        append_label(help_group,"(DWR) = Double reception" , "Ligne status " )
        ...
        append_label(help_group,"(FM,USB,AM) = Mode de reception" , "Sur la gauche en dessous de chaque VFO " )
        append_label(help_group,"(TX) = VFO utilise en cours d\'emision" , "Sur la gauche du VFO valide " )
        append_label(help_group,"(R) = Radio en reception" , "Sur la gauche de chaque VFO " )
        append_label(help_group,"(RX) = Radio en reception" , "Sur la gauche de chaque VFO " )

        append_label(help_group,"(CT) = CTCSS active" , "Affichable sous chaque VFO " )
        ...
        append_label(help_group,"(L) = Puissance LOW (Basse)" , "Affichable sous chaque VFO " )
        
        append_label(help_group,"(SQL #) = Niveau du Squelch" , "Affichable sous chaque VFO " )
        ...
        append_label(help_group,"Pour activer Le MENU supplementaire", "Tenir le bouton (PTT) et le bouton (.) puis allumer la radio" )
