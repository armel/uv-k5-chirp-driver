...
DRIVER_VERSION = "Quansheng UV-K5/K6/5R driver ver: 2024/06/13 (c) EGZUMER + F4HWN v2.8.0 FR"
...
KEYACTIONS_LIST = ["NONE",
                   ...
                   "Bascule mode Reception (MAIN ONLY)",
...
#                self._upload_calibration = bool(element.value)
    ...
    def get_settings(self):
        ...
        SetLowSetting.set_doc('SetLow : Puissance utiliser lorsque (Power) est regler sur LOW.\n' + \
