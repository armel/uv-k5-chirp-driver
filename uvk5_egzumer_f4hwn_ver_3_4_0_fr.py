...
DRIVER_VERSION = "Quansheng UV-K5/K6/5R driver ver: 2024/10/03 (c) EGZUMER + F4HWN v3.4.0 FR"
...
SCANRESUME_LIST = ["CARRIER FAST : Ecouter 100 milisecond jusqu'a ce qu\'il n\'y aie plus de signal ",
                   "CARRIER SLOW : Ecouter 2.5 second jusqu'a ce qu\'il n\'y aie plus de signal ",
                   "STOP : Arret du SCAN a la reception d'un signal ",
                   "TIMEOUT 00m:05s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:10s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:15s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:20s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:25s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:30s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:35s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:40s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:45s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:50s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 00m:55s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:00s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:05s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:10s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:15s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:20s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:25s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:30s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:35s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:40s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:45s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:50s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 01m:55s : Ecouter pour ce temp et reprendre ",
                   "TIMEOUT 02m:00s : Ecouter pour ce temp et reprendre "]
...
# bugfix calibration : put in comment next line: upload_calibration = False
    ...
    def get_memory(self, number):
        ...
        rs.set_doc('TXLock: Si le TX est permis sur ce canal, autoriser le TX')
        mem.extra.append(rs)
        # BusyCL
...
# add menu firmware with version and option display if version 3.0 and up
        ...
        if self.FIRMWARE_VERSION == "":
            ValFirm = "Firmware : Seulement lorsque lu de la radio "
...
# end add menu firmware with version and option display
        ...
        scn_rev_setting.set_doc('ScnRev : Option possible\n' + \
                                '* CARRIER FAST : 100 milisecond, Reprend le SCAN apres disparition du signal (Le squelch se ferme)\n' + \
                                '* CARRIER SLOW : 2.5 second, Reprend le SCAN apres 2.5 seconds d\'ecoute.\n' + \
                                '* TIMEOUT : Reprend le SCAN apres X seconds d\'ecoute.\n' + \
